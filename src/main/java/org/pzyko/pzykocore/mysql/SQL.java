...
public class SQL implements Closeable {
    ...
    public static String SQL_REPLACE_INTO_USER = "INSERT INTO pzyko_user (uuid, username, last_seen) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE username = ?, last_seen = ?;";
    public static String SQL_INSERT_INTO_CLAIM = "INSERT INTO pzyko_claim (world, min_x, min_z, max_x, max_z) VALUES (?, ?, ?, ?, ?);";
    public static String SQL_UPDATE_CLAIM = "UPDATE pzyko_claim SET world = ?, min_x = ?, min_z = ?, max_x = ?, max_z = ? WHERE id = ?;";
    public static String SQL_INSERT_CLAIMROLE = "INSERT IGNORE INTO pzyko_claim_user_role (claim_id, user_uuid, rolepermission) VALUES (?, ?, ?);";
    public static String SQL_SELECT_ALL_NEAR = "SELECT * FROM pzyko_claim WHERE (world = ?) AND (? BETWEEN (min_x - 100) AND (max_x + 100)) AND (? BETWEEN (min_z - 100) AND (max_z + 100));";
    public static String SQL_SELECT_USERROLE = "SELECT * FROM pzyko_claim_user_role WHERE claim_id = ?;";
